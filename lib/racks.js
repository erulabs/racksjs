        ...
        resource.assume = (function(_this) {
          return function(obj, callback) {
            if ((obj.id == null) || (obj.name == null)) {
              return _this.log('[INFO] .assume() relies on .target() which in turn requires either .id or .name on the model - please define one or the other');
            } else {
              return callback(_this.buildModel(resource, obj));
            }
          };
        })(this);
      }
    ...
    RacksJS.prototype.buildCatalog = function(serviceCatalog) {
      ...
      return serviceCatalog.forEach((function(_this) {
        return function(product) {
          var resourceName, _i, _len, _ref, _results;
